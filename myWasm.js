...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'myWasm.wast';
  var wasmBinaryFile = 'myWasm.wasm';
  var asmjsCodeFile = 'myWasm.temp.asm.js';
...
var real__count = asm["_count"]; asm["_count"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__count.apply(null, arguments);
};
...
var real__myFunc = asm["_myFunc"]; asm["_myFunc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__myFunc.apply(null, arguments);
};
...
var _myFunc = Module["_myFunc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_myFunc"].apply(null, arguments) };
